...
export class IbkBankStrategy implements BankStrategy {
  ...
  async getTransactionHistory(
    ...
    await page.waitForSelector('#ibk-date-form', { timeout: 5000 });
    ...
    await page.waitForSelector('.ibk-transaction', { timeout: 5000 });
