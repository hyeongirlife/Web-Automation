...
export class MockWooriBankStrategy implements BankStrategy {
  async login(page: Page, credentials: LoginInfo): Promise<void> {
    ...
    await page.waitForSelector('#woori-main', { visible: true, timeout: 2000 });
  }
  ...
  async getTransactionHistory(
    ...
    await page.waitForSelector('#woori-date', { timeout: 2000 });
    ...
    await page.waitForSelector('.woori-item', { timeout: 2000 });
