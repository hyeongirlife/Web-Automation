...
export class MockHanaBankStrategy implements BankStrategy {
  async login(page: Page, credentials: LoginInfo): Promise<void> {
    ...
    await page.waitForSelector('#hana-main', { visible: true, timeout: 2000 });
  }
  ...
  async getTransactionHistory(
    ...
    await page.waitForSelector('#hana-date', { timeout: 2000 });
    ...
    await page.waitForSelector('.hana-item', { timeout: 2000 });
