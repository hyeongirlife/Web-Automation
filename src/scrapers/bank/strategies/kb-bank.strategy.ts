...
export class KbBankStrategy implements BankStrategy {
  ...
  async getTransactionHistory(
    ...
    await page.waitForSelector('#kb-date-form', { timeout: 5000 });
    ...
    await page.waitForSelector('.kb-transaction', { timeout: 5000 });
